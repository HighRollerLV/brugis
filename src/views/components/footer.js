            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <a href="tel:22451193"
                           className="flex items-center mb-2 group hover:text-gray-300 transition-colors duration-300">
                            <div
                                className="bg-[#292929] p-3 rounded-full mr-3 group-hover:bg-gray-700 transition-colors duration-300">
                    ...
                    <div className="flex flex-col items-center">
                        <a href="mailto:martinsmikelsons1@inbox.lv"
                           className="flex items-center mb-2 group hover:text-gray-300 transition-colors duration-300">
                            <div
                                className="bg-[#292929] p-3 rounded-full mr-3 group-hover:bg-gray-700 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none"
